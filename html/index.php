...
<html lang="en">
    ...
    <!-- Hero -->
            <img src="../images/pngwing.com.png" alt="" class="hero-img" />

            <div class="hero-content">
              <h2><span class="discount">35%</span> SALE OFF</h2>
              <h1>
    ...
    <section class="section">
      <div class="testimonial-center container">
        <div class="testimonial">
          ...
          <div class="img-cover">
            <img src="../images/244743825_997942777417200_838392335092498276_n.jpg" alt="" />
          </div>
          <h4>Will Smith</h4>
        </div>
        <div class="testimonial">
          ...
          <div class="img-cover">
            <img src="../images/z2892519768924_de8a7118580b469cc24300e94e5ed160.jpg" alt="" />
          </div>
          <h4>Will Smith</h4>
        </div>
        <div class="testimonial">
